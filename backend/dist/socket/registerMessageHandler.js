...
exports.registerMessageHandler = void 0;
const messageController_1 = require("../controllers/messageController");
const conversationController_1 = require("../controllers/conversationController");
const mongoose_1 = require("mongoose");
const friendshipValidator_1 = require("../utils/friendshipValidator");
/**
 * Đăng ký các Socket handlers cho Message system
 */
const registerMessageHandler = (io, socket, onlineUsers) => {
    ...
    socket.on("SEND_MESSAGE", async (data) => {
        ...
        try {
            ...
            try {
                await friendshipValidator_1.FriendshipValidator.validateFriendship(senderId, receiverId);
            }
            catch (error) {
                socket.emit("MESSAGE_ERROR", {
                    success: false,
            ...
            const result = await messageController.sendMessage({
                ...
                ...(replyTo && { replyTo: new mongoose_1.Types.ObjectId(replyTo) })
            });
            if (result.success) {
    ...
    socket.on("GET_MESSAGES", async (data) => {
        try {
            ...
            const result = await messageController.getMessages(conversationId, userId, limit, skip);
        ...
        try {
            ...
            if (result.success) {
                ...
                if (message && message.conversationId) {
                    ...
                    const updatedConversation = await conversationController.getConversationById(message.conversationId, userId);
    ...
    socket.on("GET_UNREAD_COUNT", async (data) => {
        try {
            ...
            const result = await messageController.getUnreadCount(userId, data?.conversationId);
...
//# sourceMappingURL=registerMessageHandler.js.map